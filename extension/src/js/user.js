...
function addFollow() {
  if (document.getElementById("tstk-follow-container") == null) {
    runAfter(userMetaDataExists, 50, 5000, addFollowToDOM);
  }
}


function addFollowToDOM() {
  // If the page is already being updated, don't run this again. There is some weird
  // race where this could happen because the event listener triggering this apparently
  // can get issued twice
  if (isUpdatingUserPage == true) {
    return;
  }
